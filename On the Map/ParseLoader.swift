...
//    
//    func parseInfoGetter(completionHandler: (result: [MapUser]?, error: NSError?) -> Void) {
//        
...
//                }
//                else {
//                     if let parsedDictionary2 = parsedResult.valueForKey("results") as? NSArray {
...
//                        }
//                        completionHandler(result: mapUserArray, error: nil)
//                    }
//                    else {
